...
public class HomeExpensesDbContext :
    AbpDbContext<HomeExpensesDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(HomeExpensesConsts.DbTablePrefix + "YourEntities", HomeExpensesConsts.DbSchema);
