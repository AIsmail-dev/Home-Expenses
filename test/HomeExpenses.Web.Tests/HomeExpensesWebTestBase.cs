...
using HomeExpenses.Models.TokenAuth;
...
{
    public abstract class HomeExpensesWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HomeExpensesWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HomeExpensesWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HomeExpensesDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HomeExpensesDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HomeExpensesDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HomeExpensesDbContext, Task<T>> func)
        {
            T result;
